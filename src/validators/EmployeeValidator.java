...
public class EmployeeValidator {
 public static List<String> validate(Employee e,Boolean codeDuplicateCheckFlag,Boolean passwordCheckFalg){
     ...
     String password_error=validatePassword(e.getPassword(),passwordCheckFalg);
...
private static String validatePassword(String password, Boolean passwordCheckFalg) {
